...
all:
	...
	go build -o linux_backend/lib/pivotter github.com/cloudfoundry-incubator/garden-linux/containerizer/system/pivotter
	...
	CGO_ENABLED=0 go build -a -installsuffix static -o linux_backend/bin/initc github.com/cloudfoundry-incubator/garden-linux/containerizer/initc
	CGO_ENABLED=0 go build -a -installsuffix static -o linux_backend/lib/hook github.com/cloudfoundry-incubator/garden-linux/hook/hook
